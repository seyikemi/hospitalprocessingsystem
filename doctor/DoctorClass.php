<?php
    ...
    require_once("../classes/DoctorModel.php");

    $doctorObj = new DoctorModel;
    ...
    if(isset($_POST['diagnosePatient'])){
        ...
        $doctorObj->addDiagnosis($admission, $diagnosis, $doctor, $patient);
    }
    ...
    if(isset($_POST['updatediagnosePatient'])){
        ...
        $doctor = $_POST['doctorid'];
        $patient = $_POST['patientid'];
        $doctorObj->updateDiagnosis($admission, $diagnosis, $doctor, $patient);
    }
    ...
    if(isset($_POST['PrescribePatient'])){
        ...
        $pd = $_POST['details'];
        $pid = $_POST['patientid'];
        $doctorObj->addPres($pi, $p, $admission, $pd, $pid);
    }
    ...
    if(isset($_POST['UploadTests'])){
        ...
        $pi = $_POST['patientid'];
        $did = $_POST['doctorid'];
        $doctorObj->addTest($tid, $admission, $did, $tn, $tr, $pi);
    }
    ...
    if(isset($_POST['RemoveTest'])){
        ...
        $admission = $_POST['admissionid'];
        $pi = $_POST['patientid'];
        $doctorObj->removeTest($tid, $admission, $pi);
    }
    ...
    if(isset($_POST['transferPatient'])){
        ...
        $doctorObj->transfer($admission, $doctor, $last);
    }
