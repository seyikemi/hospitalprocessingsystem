        ...
        <div class="row">
            ...
            <div class="col-lg-9 " style="margin-top:2%">
                ...
                <p>ssojirin@gmail.com.com</p>
                                ...
                                <div>
                                    <a class = "nav-link btn-warning  btn btn-md">Diagnose</a>
                                    <a class = "nav-link btn-warning  btn btn-md">Prescribe Drug</a>
                                    <a class = "nav-link btn-warning  btn btn-md">View Test result</a>
                                    <a class = "nav-link btn-warning  btn btn-md">View Diagnosis</a>
                                    <a class = "nav-link btn-warning  btn btn-md">View Prescription</a>
