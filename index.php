...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.php">
                    <strong>Hospital Processing App </strong>
                </a>
        ...
        <header>
            ...
            <!-- Navbar -->
            <!-- Full Page Intro -->
            <div class="view" style="background-image: url('img/image/main.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    ...
                    <div class="container">
                        ...
                        <div class="row pt-lg-5 mt-lg-5">
                            ...
                            <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left wow fadeInLeft" data-wow-delay="0.3s">
                                <h1 class="display-4 font-weight-bold">Welcome to Hospital Processing App</h1>
                                <br>
                                <hr class="hr-light">
                                <br>
                                <h6 class="mb-3">Forward your medical complaints to us and our doctors would attend to you as soon as possible.</h6>
